...
from flight.views import (
    ...
    DesignBureauCreateView,
    DesignBureauUpdateView,
    DesignBureauDeleteView,
    CrewMemberListView,
    CrewMemberDetailView,
    CrewMemberCreateView,
    CrewMemberUpdateView,
    CrewMemberDeleteView,
    AircraftListView,
    AircraftDetailView,
    AircraftCreateView,
    AircraftUpdateView,
...
urlpatterns = [
    ...
    path(
        "bureaus/",
        DesignBureauListView.as_view(),
        name="design-bureau-list"),
    path(
        "bureaus/create/",
        DesignBureauCreateView.as_view(),
        name="design-bureau-create"
    ),
    path(
        "bureaus/<int:pk>/update/",
        DesignBureauUpdateView.as_view(),
        name="design-bureau-update",
    ),
    path(
        "bureaus/<int:pk>/delete/",
        DesignBureauDeleteView.as_view(),
    ...
    path(
        "crew/<int:pk>/update/",
        CrewMemberUpdateView.as_view(),
        name="crew-update"),
    path(
        "crew/<int:pk>/delete/",
        CrewMemberDeleteView.as_view(),
        name="crew-delete"),
    path("aircraft/", AircraftListView.as_view(), name="aircraft-list"),
    path(
        "aircraft/<int:pk>/",
        AircraftDetailView.as_view(),
        name="aircraft-detail"),
    path(
        "aircraft/create/",
        AircraftCreateView.as_view(),
        name="aircraft-create"),
    path(
        "aircraft/<int:pk>/update/",
        AircraftUpdateView.as_view(),
